import {
    blockArray, pickaxeArray, dimensionList,
...
let blockSound = new Audio("./sounds/blockSound.mp3");
let lvlUpVillager = new Audio("./sounds/lvlUpVillager.mp3");
let enchant = new Audio("./sounds/enchant.mp3");
let button = new Audio("./sounds/button.mp3");
let dimension = new Audio("./sounds/dimension.mp3");
